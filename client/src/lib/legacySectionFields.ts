...
export const HERO_SECTION_CONFIG: LegacySectionConfig = {
  ...
  fields: [
    ...
    { key: "hero.first_step", labelHe: "כותרת הצעד הראשון", labelEn: "First-step heading" },
    { key: "hero.schedule_consultation", labelHe: "שורת קביעת פגישה", labelEn: "Schedule-consultation line" },
    { key: "hero.start_now", labelHe: "טקסט כפתור ראשי", labelEn: "Primary button text" },
