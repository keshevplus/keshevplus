              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      <Label htmlFor="respondentFirstName">{isHebrew ? "שם פרטי *" : "First Name *"}</Label>
                      <Input
                        ...
                        data-testid="input-respondent-first-name"
                      />
                      {errors.respondentFirstName && <p className="text-destructive text-xs mt-1">{errors.respondentFirstName}</p>}
                    </div>
                    <div>
                      <Label htmlFor="respondentLastName">{isHebrew ? "שם משפחה *" : "Last Name *"}</Label>
                      <Input
                        ...
                        data-testid="input-respondent-last-name"
                      />
                ...
                {config.requiresChildInfo && (
                  <>
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                          <Label htmlFor="childFirstName">{isHebrew ? "שם פרטי של הילד/ה *" : "Child's First Name *"}</Label>
                          <Input
                            id="childFirstName"
                        ...
                        <div>
                          <Label htmlFor="childLastName">{isHebrew ? "שם משפחה של הילד/ה *" : "Child's Last Name *"}</Label>
                          <Input
                            id="childLastName"
