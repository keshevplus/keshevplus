const it: Record<string, string> = {
  ...
  "about.mission": "La nostra missione \u00e8 fornire una valutazione accurata e piani di trattamento personalizzati, consentendo ai nostri pazienti di raggiungere il loro pieno potenziale.",
  ...
  "adhd.treatable_desc": "Con una valutazione accurata e un piano di trattamento personalizzato, la qualit\u00e0 della vita pu\u00f2 migliorare significativamente. Il primo passo \u00e8 rivolgersi a uno specialista.",
  "adhd.early_title": "Rilevamento Precoce",
  "adhd.early_desc": "La valutazione precoce dell'ADHD pu\u00f2 aiutare ad affrontare meglio le sfide e trovare percorsi adeguati verso il successo nello studio e nella vita.",
  ...
  "faq.q3": "La valutazione \u00e8 adatta a tutte le et\u00e0?",
  "faq.a3": "S\u00ec, forniamo valutazioni professionali per bambini dai 6 anni, adolescenti e adulti. Ogni fascia d'et\u00e0 ha un protocollo di valutazione su misura che considera le caratteristiche uniche di quell'et\u00e0.",
  ...
  "faq.a5": "No, non \u00e8 necessaria l'impegnativa. Puoi contattare direttamente la clinica per prenotare un appuntamento di valutazione. Tuttavia, se hai documenti medici precedenti, \u00e8 consigliabile portarli al primo incontro.",
