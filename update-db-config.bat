...
echo DATABASE_URL=postgres://postgres:jtg3C40nG4@localhost:5432/keshev-web>> temp_env.txt

type .env | findstr /v "DB_USER DB_HOST DB_NAME DB_PASSWORD DB_PORT DATABASE_URL" >> temp_env.txt
