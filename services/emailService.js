...
// Ensure you have EMAIL_HOST, EMAIL_PORT, EMAIL_USER, and EMAIL_PASS defined in your .env file
// and in your Vercel environment variables for the backend.

const transporter = nodemailer.createTransport({
  host: process.env.EMAIL_HOST, // Should be 'smtp.gmail.com'
  port: parseInt(process.env.EMAIL_PORT || '587', 10), // 465 for SSL, 587 for TLS
...
export async function sendEmail(to, subject, html, text) {
  const mailOptions = {
    from: `"Keshev Plus" <${process.env.EMAIL_FROM || process.env.EMAIL_USER}>`, // Sender address (display name and email)
